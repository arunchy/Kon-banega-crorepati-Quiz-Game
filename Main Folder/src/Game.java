...
public class Game {
    ...
    public void Gamepage(int uid){
     ...
     correct=new JLabel();
     correct.setIcon(new ImageIcon(new ImageIcon("correct.gif").getImage().getScaledInstance(180, 180, Image.SCALE_DEFAULT)));
     ...
     wrong=new JLabel();
     wrong.setIcon(new ImageIcon(new ImageIcon("wrong.gif").getImage().getScaledInstance(180, 180, Image.SCALE_DEFAULT)));
     ...
     timer=new JLabel();
     timer.setIcon(new ImageIcon(new ImageIcon("time.png").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT)));
     timer.setBounds(750, 170,50, 50);
     fm.add(timer);
     
  
     wall1=new JLabel();
     wall1.setIcon(new ImageIcon("giphy.gif"));
     wall1.setBounds(0, 0,450, 400);
     wall1.setVisible(false);
     fm.add(wall1);

     wall2=new JLabel();
     wall2.setIcon(new ImageIcon("giphy.gif"));
     wall2.setBounds(0, 400,450, 400);
     wall2.setVisible(false);
     fm.add(wall2);

     wall3=new JLabel();
     wall3.setIcon(new ImageIcon("giphy.gif"));
     ...
     money=new JLabel();
     money.setIcon(new ImageIcon(new ImageIcon("money.png").getImage().getScaledInstance(50, 50, Image.SCALE_DEFAULT)));
   ...
   try {
    audio1 = new File("C:/Users/FCT/Group-C 32B/Main Folder/src/wrong.wav").getAbsoluteFile();
   ...
   try {
    audio2 = new File("C:/Users/FCT/Group-C 32B/Main Folder/src/congratulation.wav").getAbsoluteFile();
