...
img3=new JLabel();
img3.setIcon(new ImageIcon(getpath+"dogesh5.gif"));
img3.setBounds(0, 600,300, 300);


img4=new JLabel();
img4.setIcon(new ImageIcon(getpath+"dogesh2.gif"));
img4.setBounds(220, 600,300, 300);


img5=new JLabel();
img5.setIcon(new ImageIcon(getpath+"dogesh3.gif"));
img5.setBounds(440, 600,300, 300);

img6=new JLabel();
img6.setIcon(new ImageIcon(getpath+"dogesh1.gif"));
      ...
      if(command.equals("upload")){
       ...
       String profile=filename.getText();
        ...
        if( fullname.length()==0 && email.length()==0 && contact.length()==0 && age.length()==0 && gender.length()==0 && profile.length()==0 && pass.length()==0){
         ...
         try{
           new DbConnection();
          Users data1=new Users(uid, fullname, email, contact, age, gender, pass,profile,0,0);
