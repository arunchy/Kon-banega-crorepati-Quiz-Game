...
public class Addquestion {
    ...
    private JPanel allqus;
    private JLabel title2;
    private JLabel qustext;
    private ResultSet data1;
    private int y=90;
    private String txt;
    public void screen(){
        UsersController user=new UsersController();
        data=user.questionset();
        data1=user.showquestions();
        try {
            while(data.next()){
    ...
    title2=new JLabel("All Questions");
    title2.setBounds(150,20,300,50);
    ...
    allqus=new JPanel();
    allqus.setBounds(20,0,500,650);
    allqus.setBackground(Color.decode("#74b9ff"));
    frame.add(allqus);
